        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            <Transition
              ...
              enterForm="opacity-100 translate-y-0"
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <div className="flex flex-col leading-6 gap-3 py-3">
                <a
                  href="#"
              ...
              <div className="py-6">
                <a href="#" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7
                text-white">
                  Log In
                </a>
              </div>
